...
#ifndef SPECIALS_H_BY_CYCLOPS
#define SPECIALS_H_BY_CYCLOPS
...
struct docInfo
{
	...
	docTypeEnum type;
	formattedText title;
	list<docIdentifier> macros;
	list<docIdentifier> types;
	list<docIdentifier> globalTypes;
	list<docIdentifier> variables;
	list<docIdentifier> globalVariables;
	list<docIdentifier> functions;
	list<docIdentifier> globalFunctions;
};
